# A for loop that is used to experiment saving the ML model and loading it back in after each cycle
for train_repeat in range(0, 10, 1):    
    import time
    start_time = time.time()


    import sys
    print_file = "/root/code/ML_groepopdracht3/log/results_retrain.txt"
