...
for test_size in range(100, 1100, 100):         
    import time
    start_time = time.time()


    import sys
    print_file = "/root/code/ML_groepopdracht3/log/results_test_size.txt"
    ...
    import logging
    logging.basicConfig(filename='/root/code/ML_groepopdracht3/log/log_test_size.log', filemode='a', format='[%(levelname)s] | %(asctime)s | %(filename)s:%(lineno)d | %(message)s', datefmt='%H:%M:%S %d-%b-%y', level=logging.NOTSET)
