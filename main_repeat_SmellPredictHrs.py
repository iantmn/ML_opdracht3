...
for smell_predict_hrs in range(1, 25, 1):         
    import time
    start_time = time.time()


    import sys
    print_file = "/root/code/ML_groepopdracht3/log/results_smell_predict_hrs.txt"
    ...
    print(f"smell_predict_hrs: {smell_predict_hrs}")
