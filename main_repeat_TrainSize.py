...
for train_size in range(1000, 10000, 1000):         
    ...
    import sys
    print_file = "/root/code/ML_groepopdracht3/log/results_train_size.txt"
    ...
    import logging
    logging.basicConfig(filename='/root/code/ML_groepopdracht3/log/log_train_size.log', filemode='a', format='[%(levelname)s] | %(asctime)s | %(filename)s:%(lineno)d | %(message)s', datefmt='%H:%M:%S %d-%b-%y', level=logging.NOTSET)
